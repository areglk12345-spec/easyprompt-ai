...
export default function LoginModal() {
    ...
    const { login, register, socialLogin, isLoginModalOpen, closeLoginModal } = useAuth();
    ...
    // Removed early return to allow AnimatePresence to handle unmounting animations
            ...
            {isLoginModalOpen && (
                ...
                >
                    ...
                    <motion.div 
                        ...
                        className="relative z-10 w-full max-w-[440px] bg-white dark:bg-slate-800 rounded-[32px] p-8 md:p-10 shadow-premium dark:shadow-premium-dark border border-slate-100 dark:border-slate-700 mx-4 my-8 flex flex-col"
                    >
                        ...
                        {error && (
                            <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} className="mb-4 p-3 bg-rose-50 dark:bg-rose-900/30 border border-rose-200 dark:border-rose-800 rounded-xl text-rose-600 dark:text-rose-400 text-sm text-center font-medium">
                                {error}
                            </motion.div>
                        )}
                        {success && (
                            <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} className="mb-4 p-3 bg-emerald-50 dark:bg-emerald-900/30 border border-emerald-200 dark:border-emerald-800 rounded-xl text-emerald-600 dark:text-emerald-400 text-sm text-center font-medium">
                                {success}
                            </motion.div>
                        )}
