    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-900 p-4">
            <motion.div 
                ...
                className="w-full max-w-[440px] bg-white dark:bg-slate-800 rounded-[32px] p-8 md:p-10 shadow-premium dark:shadow-premium-dark border border-slate-100 dark:border-slate-700 mx-4 my-8 flex flex-col"
            >
                {/* Brand Logo */}
