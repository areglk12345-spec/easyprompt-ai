...
export const metadata = {
  metadataBase: new URL(process.env.NEXT_PUBLIC_SITE_URL || 'https://verbaqo.com'),
  title: 'IZPrompt | เครื่องมือสร้าง Prompt ฉบับเข้าใจง่าย',
