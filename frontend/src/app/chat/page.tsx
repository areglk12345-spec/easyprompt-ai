...
function ChatContent() {
    ...
    const startNewChat = () => {
        ...
        setMessages([
            { 
                role: 'agent', 
                text: 'สวัสดีครับ! ผมคือ EZ-Bot มาสคอตผู้ช่วยของคุณ วันนี้มีอะไรให้ผมช่วยร่างหรือสร้าง Prompt ไหมครับ? เช่น อยากให้ช่วยเขียนอีเมล, สรุปบทความ, หรือวางแผนเที่ยว บอกผมได้เลยครับ 🤖',
